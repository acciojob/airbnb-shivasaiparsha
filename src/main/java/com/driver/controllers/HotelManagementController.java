...
public class HotelManagementController {
    ...
    public Integer addUser(@RequestBody User user){
        ...
        //Assume that user will always be a valid user and return the aadharCardNo of the user
          Integer adhar = service.getAdhar(user);
       return adhar;
    }
    ...
    public String getHotelWithMostFacilities(){
        ...
        //Incase there is not even a single hotel with atleast 1 facility return "" (empty string)
           String hotel = service.getHotelFacility();
    ...
    public int bookARoom(@RequestBody Booking booking){
        ...
        int cost =service.getCost(booking);
    ...
    public int getBookings(@PathVariable("aadharCard")Integer aadharCard)
    {
        ...
        int get=service.getBookingdone(aadharCard);
        return 0;
    }
    ...
    public Hotel updateFacilities(List<Facility> newFacilities,String hotelName){
        ...
        //return the final updated List of facilities and also update that in your ho
        // telDb
